...
//               <form onSubmit={(e) => {
//                  e.preventDefault();
//                  dispatch(updateTodo({ id: todo.id, text: editInput }));
//                  setEditingId(null);
//              }}>
          ...
          >
            {editingId === todo.id ? (
              ...
              >
                ...
                <button
                  type="submit"
                  className="ml-2 text-white bg-green-500 px-2 py-1 rounded"
                >
                  Save
                </button>
                <button
                  type="button"
                  className="ml-2 text-white bg-gray-500 px-2 py-1 rounded"
